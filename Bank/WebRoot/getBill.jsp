  ...
  %>
	<div class="pd-20">
		<form class="Huiform" id="loginform"
			action="GetBillServlet?gbs=<%=gbs %>" method="post">
			<table class="table table-border table-bordered table-bg">
				...
				<tbody>
					<tr>
						...
						<td><input name="queryDate" id="queryDate"
							class="input-text" type="text" autocomplete="off"
							placeholder="输入年月份" tabindex="2" nullmsg="请输入要查询的年月份！">
						</td>
					</tr>
