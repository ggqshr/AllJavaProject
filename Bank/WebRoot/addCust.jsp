					...
					<tbody>
						<tr>
							...
							<td><input type="text" style="width: 300px"
								class="input-text" value="" placeholder="字母或者汉字" id="custName"
								name="custName" datatype="*2-16" nullmsg="用户名不能为空"></td>
						</tr>
						<tr>
							<th class="text-r"><span class="c-red">*</span><font
								size='3'> 用户密码：</font></th>
							<td><input type="password" style="width: 300px"
								class="input-text" value="" placeholder="输入密码" id="custPwd"
								onkeyup="value=value.replace(/[^\d]/g,'') " name="custPwd"></td>
						</tr>
						...
						<tr>
							<th class="text-r"><span class="c-red">*</span><font
								size='3'> 身份证号：</font></th>
							<td><input type="text" style="width: 300px"
								class="input-text" value="" placeholder="18位字符（数字和字母x）"
								id="custId" name="custId"></td>
						</tr>
						<tr>
							<th class="text-r"><span class="c-red">*</span><font
								size='3'> 预存数额：</font></th>
							<td><input type="text" style="width: 300px"
								class="input-text" value="" placeholder="" id="custMoney"
								onkeyup="value=value.replace(/[^\d]/g,'') " name="custMoney"></td>
						</tr>
						<tr>
							<th></th>
