...
<body>
	<div class="pd-20">
		<div class="Huiform">
			...
			<form id="form1" action="QueryFoodAsWeek" method="post">
				<table class="table table-border table-bordered table-bg">
					<thead>
						<tr>
							<th colspan="2"><font size='4'>请输入要查询的周内的任意一天（格式为2016-11-01）：</font></th>
						</tr>
					</thead>
					<tbody>
						<tr>
							...
							<td><input type="text" style="width: 300px"
								class="input-text" value="" id="foodName" name="WeekTime"
								datatype="*2-16"></td>
						</tr>
						<tr>
							<th></th>
							<td><button class="btn btn-success radius" type="submit">
								...
								<button type="button"
									onclick="window.location.href='manCount.jsp'"
