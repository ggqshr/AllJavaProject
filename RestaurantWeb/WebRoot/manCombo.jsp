...
<body>
	<div class="pd-20">
		<div class="Huiform">
			...
			<form id="form1" action="BaseServlet?dc=1" method="post">
					...
					<tbody>
						<tr>
							<th colspan="2"><button type="button"
									onclick="window.location.href='addCombo.jsp'"
									class="btn btn-success radius">添加套餐</button></th>
						</tr>
						<tr>
							<th colspan="2"><button type="button"
									onclick="window.location.href='queryCombo.jsp'"
									class="btn btn-success radius">更新套餐</button></th>
						</tr>
						<tr>
							<th colspan="2"><button class="btn btn-success radius">删除套餐</button></th>
						</tr>
					</tbody>
				</table>
		</div>
