   ...
   %>
	<div class="pd-20">
		<div class="Huiform">
			...
			<form id="form1" action="UpdateWaiter" method="post">
				<table class="table table-border table-bordered table-bg">
					<thead>
						<tr>
							<th colspan="2"><font size='4'>修改用户信息</font></th>
						</tr>
					</thead>
					<tbody>
						<tr>
							<th width="100" class="text-r"><span class="c-red">*</span><font
								size='3'> 员工姓名：</font></th>
							<td><%=waiter.getWaiterName() %></td>
						</tr>

						<tr>
							<th class="text-r"><span class="c-red">*</span><font
								size='3'> 员工性别：</font></th>
							<td><%=waiter.getWaiterSex() %></td>
						</tr>
						<tr>
							<th class="text-r"><span class="c-red">*</span><font
								size='3'> 员工TEL:</font></th>
							<td><input type="text" style="width: 300px"
								class="input-text" value="<%=waiter.getWaiterPhone() %>"
								placeholder="" id="waiterPhone"
