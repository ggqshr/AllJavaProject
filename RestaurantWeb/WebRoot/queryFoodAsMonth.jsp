...
<body>
	<div class="pd-20">
		<div class="Huiform">
			...
			<form id="form1" action="QueryFoodAsMonth" method="post">
				<table class="table table-border table-bordered table-bg">
					<thead>
						<tr>
							<th colspan="2"><font size='4'>请输入要查询的日期（格式为2016-11）：</font></th>
						</tr>
					</thead>
					<tbody>
						<tr>
							...
							<td><input type="text" style="width: 300px"
								class="input-text" value="" id="foodName" name="MonthTime"
								datatype="*2-16"></td>
						</tr>
						<tr>
							<th></th>
