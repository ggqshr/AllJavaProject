...
<body>
	<div class="pd-20">
		<div class="Huiform">
			...
			<form id="form1" action="AddFood" method="post">
					...
					<tbody>
						...
						<tr>
							<th width="100" class="text-r"><span class="c-red">*</span><font
								size='3'> 食物类型</font></th>
							<td>
							<label><input name="foodType" type="radio" value="meat" />肉类 </label> 
							<label><input name="foodType" type="radio" value="vegetable" />素菜 </label> 
							<label><input name="foodType" type="radio" value="soup" />汤类 </label> 
							<label><input name="foodType" type="radio" value="noodles" />面食 </label>
							</td>
						</tr>
						<tr>
