...
<body>
	<div class="pd-20">
		<div class="Huiform">
			...
			<form id="form1" action="BaseServlet?of=1" method="post">
				<table class="table table-border table-bordered table-bg">
					...
					<tbody>
						<tr>
							<th colspan="2"><button type="button" onclick="tj('food')"
									class="btn btn-success radius">单点饭菜</button></th>
						</tr>
						<tr>
							<th colspan="2"><button type="button" onclick="tj('combo')"
									class="btn btn-success radius">点套餐</button></th>
						<tr>
