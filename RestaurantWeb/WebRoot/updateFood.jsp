  ...
  %>
	<div class="pd-20">
		<div class="Huiform">
			...
			<form id="form1" action="UpdateFood" method="post">
				<table class="table table-border table-bordered table-bg">
					<thead>
						<tr>
							<th colspan="2"><font size='4'>修改食物信息</font></th>
						</tr>
					</thead>
					<tbody>
						<tr>
							...
							<td><input type="text" style="width: 300px"
								class="input-text" value=<%=food.getFoodName() %>
								placeholder="字母或者汉字" id="foodName" name="foodName"
						...
						<tr>
							<th class="text-r"><span class="c-red">*</span><font
								size='3'> 食物价格：</font></th>
							<td><input type="text" style="width: 300px"
								class="input-text" value=<%=food.getFoodPrice() %>
								id="foodPrice" name="foodPrice"></td>
						</tr>
						<tr>
							<th class="text-r"><span class="c-red">*</span><font
								size='3'> 食物余量:</font></th>
							<td><input type="text" style="width: 300px"
								class="input-text" value=<%=food.getFoodBanlance() %>
								placeholder="" id="foodBanlance"
