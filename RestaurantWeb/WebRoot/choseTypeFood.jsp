...
<body>
	<%
  String adr=(String)session.getAttribute("adr2");

   %>
	<div class="pd-20">
		<div class="Huiform">
			<!--  <form action="userUpdateServlet" method="post"> -->
			<form id="form1" action="OrderCombo" method="post">
				<table class="table table-border table-bordered table-bg">
					...
					<tbody>
						...
						<tr>
							<%
        List<Food> foods=(List<Food>)session.getAttribute("foodType");
          String  sd=(String)session.getAttribute("comboIfm");
        int num=1;
        for (Food food : foods) {
