...
<body>
	<div class="pd-20">
		<div class="Huiform">
			...
			<form id="form1" action="QueryCombo" method="post">
				<table class="table table-border table-bordered table-bg">
					...
					<tbody>
						<tr>
							<th width="200" class="text-r"><span class="c-red">*</span><font
								size='3'> 套餐姓名或者编号：</font></th>
							<td><input type="text" style="width: 300px"
								class="input-text" value="" id="comboIfm" name="comboIfm"
								datatype="*2-16"></td>
						</tr>
						<tr>
							<th></th>
