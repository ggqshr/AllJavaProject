...
public class QueryFoodAsDay extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public QueryFoodAsDay() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		List<Food> foods=businessDao.businessQueryAsDay(day);
		...
		session.setAttribute("adr", "queryFoodAsDay.jsp");
//		//if(foods.size()==0)
//		{
//			out.println("<script>alert('此日无订单，请重新输入')</script>");
//			out.println("<script>location.href='queryFoodAsDay.jsp'</script>");
//			return ;
//		}
